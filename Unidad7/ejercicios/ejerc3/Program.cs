...
namespace ejerc3
{
    class Program
    {
        ...
        {
         /*3. Hacer un programa que solicite una cadena de caracteres y
         dos caracteres sueltos (tres ingresos).
         El programa deberá generar una cadena donde todas las ocurrencias del primer
         carácter dado hayan sido reemplazadas por el segundo. 
        ...
        frase[indice] = '\0'; //El \0 determina el final real de la cadena.
